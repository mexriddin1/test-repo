...
export default function CarCard(props: Props) {
  ...
  return (
    <div className="rounded-2xl w-full sm:w-[600px] snap-start overflow-hidden transition-shadow duration-150 bg-white shadow-sm">
      <div className="relative h-[260px] sm:h-[340px]">
        ...
        <div className="absolute top-3 right-3 bg-white text-primary px-4 py-2 font-medium rounded-full text-sm shadow">
          ${price}/per day
        </div>
      </div>
