              ...
              <MapPin/> {tour.location}
                    ...
                    <aside className="lg:col-span-1">
                        <div className="border rounded-2xl p-6 sticky top-6">
                            ...
                            <Button
                                ...
                                {bookingLoading ? <Loader2 className="animate-spin mr-2"/> : t("send")}
                            </Button>
                        </div>
                    </aside>
                </div>
                ...
                <div className="flex flex-col gap-6 sm:gap-8 mt-8">
                    ...
                    <section className="w-full flex flex-col">
                        <div
                            className="flex flex-col sm:flex-row gap-6 overflow-x-auto sm:overflow-x-visible scrollbar-hide snap-y sm:snap-x snap-mandatory ">
                            {tours.length
